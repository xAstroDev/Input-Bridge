...
public final /* synthetic */ class XInputEightDirMoveEvents$$ExternalSyntheticLambda1 implements Observer {
    ...
    public /* synthetic */ XInputEightDirMoveEvents$$ExternalSyntheticLambda1(XInputEightDirMoveEvents xInputEightDirMoveEvents, Int2 int2, TouchableWindowElement touchableWindowElement, Int2 int22, IInputDevice iInputDevice) {
    ...
    public final void update(Observable observable, Object obj) {
        this.f$0.m51lambda$new$1$comcatfixtureinputbridgecoreinputdevicestouchcommonsXInputEightDirMoveEvents(this.f$1, this.f$2, this.f$3, this.f$4, observable, obj);
    }
}
