...
class FontRequestWorker {
    private static final ExecutorService DEFAULT_EXECUTOR_SERVICE = RequestExecutor.createDefaultExecutor("fonts-androidx", 10, MainControlsOverlayFragment.ID_MAIN_CONTROLS_OVERLAY);
