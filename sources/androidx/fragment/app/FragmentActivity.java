...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new FragmentActivity$$ExternalSyntheticLambda1(this));
    ...
    public /* synthetic */ void m3lambda$init$1$androidxfragmentappFragmentActivity(Context context) {
