...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    private final boolean tryFinalizeSimpleState(Incomplete incomplete, Object obj) {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(obj instanceof CompletedExceptionally))) {
            throw new AssertionError();
        } else if (!SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, incomplete, JobSupportKt.boxIncomplete(obj))) {
            return false;
        } else {
    ...
    private final int startInternal(Object obj) {
        if (obj instanceof Empty) {
            ...
            if (!SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, JobSupportKt.EMPTY_ACTIVE)) {
                return -1;
            }
            onStart();
            return 1;
    ...
    public final DisposableHandle invokeOnCompletion(boolean z, boolean z2, Function1<? super Throwable, Unit> function1) {
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                } else if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, state$kotlinx_coroutines_core, makeNode)) {
                    return makeNode;
                }
            } else {
                Throwable th = null;
    ...
    private final java.lang.Object tryMakeCompletingSlowPath(kotlinx.coroutines.Incomplete r7, java.lang.Object r8) {
        ...
        L_0x002a:
            ...
            boolean r4 = kotlin.SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(r4, r6, r7, r1)     // Catch:{ all -> 0x008c }
    ...
    public final void removeNode$kotlinx_coroutines_core(kotlinx.coroutines.JobNode r4) {
        ...
        L_0x000b:
            ...
            boolean r0 = kotlin.SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(r1, r3, r0, r2)
