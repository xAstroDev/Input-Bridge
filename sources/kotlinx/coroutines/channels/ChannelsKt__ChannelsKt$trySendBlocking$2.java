    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m246constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m246constructorimpl(Unit.INSTANCE);
        if (Result.m253isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1706successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1704closedJP2dKIU(Result.m249exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1691boximpl(obj3);
    }
}
