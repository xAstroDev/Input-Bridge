...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m1691boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Object m1692constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1693equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).m1703unboximpl());
    }
    ...
    public int hashCode() {
        return m1698hashCodeimpl(this.holder);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Object m1703unboximpl() {
        return this.holder;
    }
    ...
    public static final boolean m1701isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }

    /* renamed from: isFailure-impl  reason: not valid java name */
    public static final boolean m1700isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }
    ...
    public static final T m1696getOrNullimpl(Object obj) {
    ...
    public static final T m1697getOrThrowimpl(Object obj) {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m1695exceptionOrNullimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m1706successJP2dKIU(E e) {
            return ChannelResult.m1692constructorimpl(e);
        }

        /* renamed from: failure-PtdJZtk  reason: not valid java name */
        public final <E> Object m1705failurePtdJZtk() {
            return ChannelResult.m1692constructorimpl(ChannelResult.failed);
        }

        /* renamed from: closed-JP2dKIU  reason: not valid java name */
        public final <E> Object m1704closedJP2dKIU(Throwable th) {
            return ChannelResult.m1692constructorimpl(new Closed(th));
        }
    }

    public String toString() {
        return m1702toStringimpl(this.holder);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1702toStringimpl(Object obj) {
        if (obj instanceof Closed) {
            return obj.toString();
        }
        return "Value(" + obj + ')';
