...
public final class DelayKt {
    ...
    public static final Object m1672delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1673toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1673toDelayMillisLRDsOJo(long j) {
        if (Duration.m1529compareToLRDsOJo(j, Duration.Companion.m1632getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1548getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
