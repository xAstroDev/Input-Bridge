...
public final class FastServiceLoader {
    ...
    private final java.util.List<java.lang.String> parse(java.net.URL r6) {
        /*
            ...
            java.io.InputStreamReader r2 = new java.io.InputStreamReader     // Catch:{ all -> 0x005b }
            java.util.zip.ZipEntry r3 = new java.util.zip.ZipEntry     // Catch:{ all -> 0x005b }
            r3.<init>(r0)     // Catch:{ all -> 0x005b }
            java.io.InputStream r0 = r1.getInputStream(r3)     // Catch:{ all -> 0x005b }
            java.lang.String r3 = "UTF-8"
            r2.<init>(r0, r3)     // Catch:{ all -> 0x005b }
            java.io.Reader r2 = (java.io.Reader) r2     // Catch:{ all -> 0x005b }
            r6.<init>(r2)     // Catch:{ all -> 0x005b }
            java.io.Closeable r6 = (java.io.Closeable) r6     // Catch:{ all -> 0x005b }
            r0 = r4
            java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch:{ all -> 0x005b }
            r0 = r6
            java.io.BufferedReader r0 = (java.io.BufferedReader) r0     // Catch:{ all -> 0x0054 }
            kotlinx.coroutines.internal.FastServiceLoader r2 = INSTANCE     // Catch:{ all -> 0x0054 }
            java.util.List r0 = r2.parseFile(r0)     // Catch:{ all -> 0x0054 }
            kotlin.io.CloseableKt.closeFinally(r6, r4)     // Catch:{ all -> 0x005b }
        ...
        L_0x0056:
            r2 = move-exception
            kotlin.io.CloseableKt.closeFinally(r6, r0)     // Catch:{ all -> 0x005b }
        ...
        L_0x0067:
            ...
            r6 = r0
            java.io.BufferedReader r6 = (java.io.BufferedReader) r6     // Catch:{ all -> 0x0089 }
            kotlinx.coroutines.internal.FastServiceLoader r1 = INSTANCE     // Catch:{ all -> 0x0089 }
            java.util.List r6 = r1.parseFile(r6)     // Catch:{ all -> 0x0089 }
