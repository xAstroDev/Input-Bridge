...
public class LockFreeLinkedListNode {
    ...
    public static class AddLastDesc<T extends LockFreeLinkedListNode> extends AbstractAtomicDesc {
        ...
        public void finishPrepare(PrepareOp prepareOp) {
            SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_affectedNode$FU, this, (Object) null, prepareOp.affected);
        }
    ...
    public static class RemoveFirstDesc<T> extends AbstractAtomicDesc {
        ...
        public void finishPrepare(PrepareOp prepareOp) {
            SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_affectedNode$FU, this, (Object) null, prepareOp.affected);
            SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_originalNext$FU, this, (Object) null, prepareOp.next);
        }
    ...
    public static final class PrepareOp extends OpDescriptor {
        ...
        public Object perform(Object obj) {
            ...
            SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, obj3);
            return null;
        }
            ...
            while (true) {
                ...
                if (obj instanceof OpDescriptor) {
                    ...
                    if (retry(takeAffectedNode, obj)) {
                        ...
                        if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, takeAffectedNode, obj, prepareOp)) {
                            try {
                                ...
                                SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, takeAffectedNode, prepareOp, obj);
                                throw th;
                            }
                        } else {
                            continue;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0048, code lost:
        if (kotlin.SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_next$FU, r3, r2, ((kotlinx.coroutines.internal.Removed) r4).ref) != false) goto L_0x004b;
     */
