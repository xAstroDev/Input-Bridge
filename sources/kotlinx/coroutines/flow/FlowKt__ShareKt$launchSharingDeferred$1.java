...
final class FlowKt__ShareKt$launchSharingDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$upstream.collect(new FlowKt__ShareKt$launchSharingDeferred$1$invokeSuspend$$inlined$collect$1(objectRef, coroutineScope, this.$result), this) == coroutine_suspended) {
