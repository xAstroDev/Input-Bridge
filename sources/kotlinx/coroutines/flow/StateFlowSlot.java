...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
        ...
        while (true) {
            ...
            if (obj != null && obj != StateFlowKt.PENDING) {
                if (obj == StateFlowKt.NONE) {
                    if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, StateFlowKt.PENDING)) {
                        return;
                    }
                } else if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, StateFlowKt.NONE)) {
                    Unit unit = Unit.INSTANCE;
                    Result.Companion companion = Result.Companion;
                    ((CancellableContinuationImpl) obj).resumeWith(Result.m246constructorimpl(unit));
                    return;
                }
            } else {
                return;
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || (!(this._state instanceof CancellableContinuationImpl))) {
            if (!SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, StateFlowKt.NONE, cancellableContinuation)) {
