...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    private final void closeQueue() {
        if (!DebugKt.getASSERTIONS_ENABLED() || isCompleted()) {
            while (true) {
                Object obj = this._queue;
                if (obj == null) {
                    if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, (Object) null, EventLoop_commonKt.CLOSED_EMPTY)) {
                        return;
                    }
    ...
    private final int scheduleImpl(long j, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            ...
            SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_delayed$FU, this, (Object) null, new DelayedTaskQueue(j));
    ...
    private final boolean enqueueImpl(Runnable runnable) {
        while (true) {
            ...
            if (obj == null) {
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, (Object) null, runnable)) {
                    return true;
                }
            } else if (obj instanceof LockFreeTaskQueueCore) {
                ...
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore2)) {
                    return true;
                }
            }
        }
    ...
    private final Runnable dequeue() {
        while (true) {
            ...
            if (obj instanceof LockFreeTaskQueueCore) {
                ...
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, (Object) null)) {
                    Objects.requireNonNull(obj, "null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
                    return (Runnable) obj;
                }
            }
