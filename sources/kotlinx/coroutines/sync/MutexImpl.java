    ...
    private static final class TryLockDesc extends AtomicDesc {
        ...
        private final class PrepareOp extends OpDescriptor {
            ...
            public Object perform(Object obj) {
                ...
                SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(MutexImpl._state$FU, (MutexImpl) obj, this, access$getEMPTY_UNLOCKED$p);
                return null;
            }
        }
        ...
        public Object prepare(AtomicOp<?> atomicOp) {
            ...
            if (!SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(MutexImpl._state$FU, this.mutex, MutexKt.EMPTY_UNLOCKED, prepareOp)) {
    ...
    public void unlock(Object obj) {
        while (true) {
            ...
            if (obj2 instanceof Empty) {
                ...
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj2, MutexKt.EMPTY_UNLOCKED)) {
                    return;
                }
            } else if (obj2 instanceof OpDescriptor) {
                ((OpDescriptor) obj2).perform(this);
