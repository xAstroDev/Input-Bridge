...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m1436getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public final long m1458getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1459getLastsVKNKU() {
        return this.last;
    }
    ...
    public final Iterator<ULong> iterator() {
        return new ULongProgressionIterator(m1458getFirstsVKNKU(), m1459getLastsVKNKU(), this.step, (DefaultConstructorMarker) null);
    }

    public boolean isEmpty() {
        int i = (this.step > 0 ? 1 : (this.step == 0 ? 0 : -1));
        long r3 = m1458getFirstsVKNKU();
        long r5 = m1459getLastsVKNKU();
        if (i > 0) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ULongProgression) {
            if (!isEmpty() || !((ULongProgression) obj).isEmpty()) {
                ...
                if (!(m1458getFirstsVKNKU() == uLongProgression.m1458getFirstsVKNKU() && m1459getLastsVKNKU() == uLongProgression.m1459getLastsVKNKU() && this.step == uLongProgression.step)) {
                    return false;
                }
            }
            return true;
    ...
    public int hashCode() {
        ...
        long j = this.step;
        return (((((int) ULong.m418constructorimpl(m1458getFirstsVKNKU() ^ ULong.m418constructorimpl(m1458getFirstsVKNKU() >>> 32))) * 31) + ((int) ULong.m418constructorimpl(m1459getLastsVKNKU() ^ ULong.m418constructorimpl(m1459getLastsVKNKU() >>> 32)))) * 31) + ((int) (j ^ (j >>> 32)));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m463toStringimpl(m1458getFirstsVKNKU()));
            sb.append("..");
            sb.append(ULong.m463toStringimpl(m1459getLastsVKNKU()));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1460fromClosedRange7ftBX0g(long j, long j2, long j3) {
