...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1524getAdjustmentUwyO8pc() {
    ...
    public long m1523elapsedNowUwyO8pc() {
        return Duration.m1565minusLRDsOJo(this.mark.m1659elapsedNowUwyO8pc(), m1524getAdjustmentUwyO8pc());
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1525plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1566plusLRDsOJo(m1524getAdjustmentUwyO8pc(), j), (DefaultConstructorMarker) null);
    }
}
