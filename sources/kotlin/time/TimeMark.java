...
public abstract class TimeMark {
    ...
    public abstract long m1659elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1661plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this, j, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1660minusLRDsOJo(long j) {
        return m1661plusLRDsOJo(Duration.m1582unaryMinusUwyO8pc(j));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1563isNegativeimpl(m1659elapsedNowUwyO8pc());
    }
